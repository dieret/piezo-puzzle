...
float song0[51][2] = {{391.998, 190}, {0.000, 10}, {391.998, 190}, {0.000, 10},
                      {440.001, 390}, {0.000, 10}, {391.998, 390}, {0.000, 10},
                      {523.251, 390}, {0.000, 10}, {493.884, 790}, {0.000, 10},
                      {391.998, 190}, {0.000, 10}, {391.998, 190}, {0.000, 10},
                      {440.001, 390}, {0.000, 10}, {391.998, 390}, {0.000, 10},
                      {587.332, 390}, {0.000, 10}, {523.251, 790}, {0.000, 10},
                      {391.998, 190}, {0.000, 10}, {391.998, 190}, {0.000, 10},
                      {783.991, 390}, {0.000, 10}, {659.255, 390}, {0.000, 10},
                      {523.251, 390}, {0.000, 10}, {493.884, 390}, {0.000, 10},
                      {440.001, 390}, {0.000, 10}, {698.457, 190}, {0.000, 10},
                      {698.457, 190}, {0.000, 10}, {659.255, 390}, {0.000, 10},
                      {523.251, 390}, {0.000, 10}, {587.332, 390}, {0.000, 10},
                      {523.251, 790}, {0.000, 10}, {0.0, -1.0}};

float song1[51][2] = {{261.626, 390}, {0.000, 10}, {349.229, 390}, {0.000, 10},
...
float hint[37][2] = {
    {293.663, 250},  {293.663, 20},   {314.414, 20},   {336.623, 20},
    {360.407, 20},   {385.868, 20},   {413.131, 20},   {442.314, 20},
    {473.566, 20},   {507.024, 20},   {542.843, 20},   {581.195, 20},
    {622.253, 20},   {622.253, 500},  {587.332, 3000}, {698.457, 250},
    {698.457, 20},   {638.806, 20},   {584.252, 20},   {534.358, 20},
    {488.723, 20},   {446.987, 20},   {408.814, 20},   {373.899, 20},
    {341.968, 20},   {312.767, 20},   {286.052, 20},   {261.626, 20},
    {261.626, 500},  {293.663, 4000}, {587.332, 750},  {466.163, 250},
    {293.663, 1000}, {349.229, 750},  {311.126, 250},  {293.663, 1000},
    {0.0, -1.0}};
